...
describe(`Storage`, () => {
  ...
  it(`Should getBy prop`, () => {
    const storage = new Storage<Phase, Omit<Phase, `id`>>([
      { id: "0", title: `phase-0`, description: ``, isComplete: false, locked: false, seqNo: 0, startupId: `0` },
      { id: "1", title: `phase-1`, description: ``, isComplete: false, locked: true, seqNo: 1, startupId: `0` },
      { id: "2", title: `phase-2`, description: ``, isComplete: false, locked: false, seqNo: 0, startupId: `1` },
    ])
