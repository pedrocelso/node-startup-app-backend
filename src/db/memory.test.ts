...
const phases: Phase[] = [
  { id: "0", title: "phase-0", description: "", isComplete: false, seqNo: 0, startupId: "0", locked: false },
  { id: "1", title: "phase-1", description: "", isComplete: false, seqNo: 1, startupId: "0", locked: true },
  { id: "2", title: "phase-2", description: "", isComplete: false, seqNo: 2, startupId: "0", locked: true },
  { id: "3", title: "phase-3", description: "", isComplete: true, seqNo: 0, startupId: "1", locked: false },
  { id: "4", title: "phase-4", description: "", isComplete: false, seqNo: 1, startupId: "1", locked: false },
  { id: "5", title: "phase-5", description: "", isComplete: false, seqNo: 5, startupId: "1", locked: true },
  { id: "6", title: "phase-6", description: "", isComplete: false, seqNo: 0, startupId: "4", locked: false },
  { id: "7", title: "phase-7", description: "", isComplete: true, seqNo: 0, startupId: "3", locked: false },
]
...
describe(`.insertPhase()`, () => {
  it(`Should insert a new phase`, () => {
    ...
    const result = db.insertPhase({ startupId: "0", seqNo: 3, description: "desc-phase-3", title: "phase-3" })
  ...
  it(`Should fail if startup does not exist`, () => {
    ...
    const result = db.insertPhase({ startupId: "999", seqNo: 2, description: "desc-phase-3", title: "phase-3" })
  ...
  it(`Should fail if seqNo is already taken`, () => {
    ...
    const count = db.getPhases("0").length
    const result = db.insertPhase({ startupId: "0", seqNo: 2, description: "desc-phase-3", title: "phase-3" })
